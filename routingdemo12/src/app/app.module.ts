...
import { NameFilterPipe } from './SharedModule/name-filter.pipe';
...
@NgModule({
  declarations: [
    ...
    EmployeeDetailsComponent,RouteParameterComponent, EditCustomerComponent, AssignInitialPipe, NameFilterPipe
